...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		...
		//La linea anterior la comentamos dado que ya queda desacoplado el host y el puerto gracias al Balancerador Ribbon 
		//parámetro configurador en el Application Properties. Solo hace falta indicar el nombre del microservicio
	...
	public void delete(Long id) {
		...
		clienteRest.delete("http://servicio-productos/eliminar/{id}", uriVariables);
	}
